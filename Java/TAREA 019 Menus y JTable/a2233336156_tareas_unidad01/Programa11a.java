...
public class Programa11a extends JFrame {
    ...
    public Programa11a() {
        ...
        ActionListener menuActionListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JDialog dialog = new JDialog(Programa11a.this, source.getText(), true);
                dialog.setSize(300, 200);
                dialog.setLocationRelativeTo(Programa11a.this);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new Programa11a().setVisible(true);
        });
    }
}